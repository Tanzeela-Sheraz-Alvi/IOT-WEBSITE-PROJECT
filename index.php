...
<div class="hero">
 ...
 <nav>
        ...
        <img src="images/logo1.png" class="cloud">
    ...
    <form action="connect.php" method="POST">
            ...
            <p>create an Account?<button id="Signup-form">Signup</button></p>
        </form>
    </div>
...
<div class="container">
    ...
    <section id="about">
        <img src="images/mob.jpg.jpg" alt="Iotify Device" class="product-img">
        <div class="text-content">
            <p class="small-text">What is Iotify ??</p>
            <h1 class="bold-text">Your Digital Smart Home Assistant</h1>
            <p class="description-text">
                Iotify is a state-of-the-art smart home assistant that brings convenience, 
                automation, and security to your fingertips. With its advanced IoT capabilities, 
                it connects various devices, offering seamless control over lighting, temperature, 
                security, and entertainment. Your home, your rules, all controlled effortlessly with Iotify.
            </p>
        </div>
    </section>
        ...
        <section class="why-choose">
            ...
            <div class="flex-container">
                ...
                <div class="centered-image">
                    <img src="images/mob1.jpg.jpg" alt="iPhone Display with IoT Devices" class="iphone-img">
                </div>
                <!-- Right Side Boxes -->
